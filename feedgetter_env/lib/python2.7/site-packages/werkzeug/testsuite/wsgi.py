...
class WSGIUtilsTestCase(WerkzeugTestCase):
    ...
    def test_path_info_extraction(self):
        x = wsgi.extract_path_info('http://example.com/controller', '/controller/hello')
        self.assert_equal(x, u'/hello')
        x = wsgi.extract_path_info('http://example.com/controller',
                                   'https://example.com/controller/hello')
        self.assert_equal(x, u'/hello')
        x = wsgi.extract_path_info('http://example.com/controller/',
                                   'https://example.com/controller/hello')
        self.assert_equal(x, u'/hello')
