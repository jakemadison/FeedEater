...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, controller) tuple."""
...
class SQLAlchemy(object):
    ...
    versioning examples.::
        ...
        controller = Flask(__name__)
        db = SQLAlchemy(controller, session_extensions=[VersionedListener()])
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(controller)).
        """
