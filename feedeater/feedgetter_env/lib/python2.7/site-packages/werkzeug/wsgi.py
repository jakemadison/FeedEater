...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(controllerrocontrollertroller/hello')
    u'/hello'
    >>> extract_path_info(controller,
    ... controller               controller)
    u'/hello'
    >>> econtrolleract_path_info(controller,
    ...                   controller,
    .controller                  collapse_http_schemes=False) is controllere
    True
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(controllerpath.dirname(__file__), controllerared')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': ('myapplicaticontroller, 'shared_files')
      controller)
