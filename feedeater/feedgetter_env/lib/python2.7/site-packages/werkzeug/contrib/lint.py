...
class LintMiddleware(object):
    ...
    ::
        ...
        controller = LintMiddleware(controller)
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI controller required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI controller allowed'),
                 stacklevel=2)
